table 50118 "SO Import Buffer"
{
    ...
    internal procedure OpenBookStream(IStream: InStream; SheetName: Text[100])
    begin
        Error('Procedure OpenBookStream not implemented.');
    end;

    internal procedure SelectSheetsNameStream(IStream: InStream): Text[100]
    begin
        Error('Procedure SelectSheetsNameStream not implemented.');
    end;
}